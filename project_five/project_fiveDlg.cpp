...
CprojectfiveDlg::CprojectfiveDlg(CWnd* pParent /*=nullptr*/)
	...
	, m_server_port(0)
	, m_send_message(_T(""))
	, m_send_view_message(_T(""))
	, m_rev_view_message(_T(""))
{
...
void CprojectfiveDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_EDIT1, m_server_port);
	DDX_Text(pDX, IDC_EDIT3, m_send_message);
	DDX_Text(pDX, IDC_EDIT5, m_send_view_message);
	DDX_Text(pDX, IDC_EDIT4, m_rev_view_message);
}
...
BEGIN_MESSAGE_MAP(CprojectfiveDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_EN_CHANGE(IDC_EDIT3, &CprojectfiveDlg::OnEnChangeEdit3)
END_MESSAGE_MAP()
...
void CprojectfiveDlg::OnEnChangeEdit3()
{
